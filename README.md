...
**1. Classification:**
A single capture being classified as worn doesn't guarantee the belt is worn. It could've happened by chance or it may be a temporary fault. It is much more useful to see if there is a trend of worn captures which can be used to make more confident statements about belt wear. 
